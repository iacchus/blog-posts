title: Setting Up a Wacom Tablet on Linux using Python
slug: setting-up-a-wacom-tablet-on-linux-using-python
lang: en
date: Sat Aug  7 12:41:39 AM -03 2021
modified: Sat Aug  7 12:58:59 AM -03 2021
tags: linux, wacom, python, scripting
summary: 
status: published

Well, yesterday I was setting up a Wacom tablet on Archlinux, using
`xsetwacom`. I ended up with [this script](https://github.com/iacchus/wacom-linux-tool).
